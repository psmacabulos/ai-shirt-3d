                ...
                readonly openai: {
                    ...
                    readonly properties: {
                        readonly nsfw_likelihood: {
                            readonly description: "An integer representing the likelihood of NSFW content. Higher values indicate a higher likelihood.";
                            readonly title: "Nsfw Likelihood";
                            readonly type: "integer";
                        };
                        readonly nsfw_likelihood_score: {
                            readonly description: "A floating-point score representing the confidence level of the NSFW likelihood assessment. This is typically a value between 0.0 and 1.0.";
                            readonly title: "Nsfw Likelihood Score";
                            readonly type: "integer";
                        };
                        readonly items: {
                            readonly description: "A list of items identified as potentially explicit. Each item contains details of the explicit content detected.";
                            readonly title: "Items";
                            readonly type: "array";
                            readonly items: {
    ...
    readonly body: {
        ...
        readonly properties: {
            ...
            readonly face_id: {
                ...
                readonly examples: readonly ["179ec000-23b0-43cf-8144-bce5f877e68c"];
            };
        };
    ...
    readonly body: {
        ...
        readonly properties: {
            ...
            readonly text: {
                readonly type: "string";
                readonly minLength: 1;
                readonly description: "Description of the desired image(s).";
        ...
        readonly "200": {
            readonly properties: {
                readonly openai: {
                    ...
                    readonly properties: {
                        readonly items: {
                            readonly description: "List of the detected brands logo from the image.";
                            readonly title: "Items";
                            readonly type: "array";
                            readonly items: {
                                readonly required: readonly ["description", "score"];
                                ...
                                readonly properties: {
                                    readonly bounding_poly: {
                                        ...
                                        readonly properties: {
                                            readonly vertices: {
                                                readonly description: "Vertices of the logos in the image";
                                                ...
                                                readonly items: {
                                                    ...
                                                    readonly properties: {
                                                        readonly x: {
                                                            readonly description: "The x-coordinate of the vertex.";
                                                            readonly title: "X";
                                                            readonly type: "integer";
                                                        };
                                                        readonly y: {
                                                            readonly description: "The y-coordinate of the vertex.";
                                                            readonly title: "Y";
                                                            readonly type: "integer";
                                                        };
                                                    };
                                    ...
                                    readonly description: {
                                        readonly description: "Name of the logo";
                                        readonly title: "Description";
                                        readonly type: "string";
                                    };
                                    readonly score: {
                                        readonly description: "Confidence score how sure it's this is a real logo.";
